...
class EnhancedMapEditorGUI:
    ...
    def create_menu(self):
        ...
        file_menu.add_command(label="新建地图", command=self.new_map)
        file_menu.add_command(label="打开地图", command=self.open_map)
        file_menu.add_command(label="保存地图", command=self.save_map)
